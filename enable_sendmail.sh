...
if [ "$#" -ne 2 ]; then
  echo "usage: enable_sendmail.sh <hostname> <destination>"
  echo ""
  echo "  hostname: hostname this server represents, like foo.example.com"
  echo "  destination: email address, like foo+automated@gmail.com"
  exit 1
fi
